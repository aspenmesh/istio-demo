...
# Install nginx proxy in minikube
cat install-demo/minikube/proxy-istio-ingress.yaml
kubectl apply -f install-demo/minikube/proxy-istio-ingress.yaml

# setup routing for istio ingressgateway for minikube
# MINIKUBE_IP=$(minikube ip)
# Open Gasmask and create a new local resolver file
